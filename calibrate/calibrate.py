r"""
En una consola cambiar a la carpeta donde se encuentra este archivo, por ejemplo:

D:
cd D:\\handmesure\calibrate
...
python calibrate.py D:\\ruta\a\imagenes\sin_calibrar D:\\ruta\a\imagenes\calibradas\

o directamente:

python calibrate.py

que toma todas las imágenes de \\10.10.204.24\scan4d\TENDER\HANDS_SIN_CALIBRAR
y las guarda calibradas en \\10.10.204.24\scan4d\TENDER\HANDS_CALIBRADAS
